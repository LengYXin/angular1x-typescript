...
(function($) {
    ...
    Calendar.prototype._loadTemplate = function(name) {
        ...
        // }).done(function(html) {
        self.options.templates[name] = _.template(templateHtml[name]);
        // });
    };
    ...
    Calendar.prototype._update_month_year = function() {
        ...
        var self = this;
        var activecell = 0;
        var downbox = $(document.createElement('div')).attr('id', 'cal-day-tick').html('<i class="icon-angle-down"></i>');
