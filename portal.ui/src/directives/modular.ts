...
//   public/samHeader
import samHeader from './public/samHeader';
modularList.push({ name: 'samHeader',  val:samHeader.$instance});
//   public/samMainMenu
import samMainMenu from './public/samMainMenu';
modularList.push({ name: 'samMainMenu',  val:samMainMenu.$instance});
//   public/samMenu
...
//   public/samTreeNode
import samTreeNode from './public/samTreeNode';
modularList.push({ name: 'samTreeNode',  val:samTreeNode.$instance});
//   public/samZoom
